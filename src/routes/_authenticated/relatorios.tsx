...
function RelatoriosPage() {
  ...
  async function handlePDF() {
    if (!isPremium) {
      toast.info("Exportar em PDF é do plano Business", {
        description: "Assine o Business para baixar seus relatórios em PDF.",
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-1.5">
            ...
            <button
              onClick={handlePDF}
              disabled={exporting !== null || loading}
              title={isPremium ? "Exportar relatório em PDF" : "Disponível no plano Business"}
